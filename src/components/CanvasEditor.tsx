...
export const CanvasEditor = () => {
	...
	useEffect(() => {
		...
		canvas.getObjects().forEach((obj: any) => {
			const isHovered = obj.id === canvasEvents.selection.objectState.hoveredObjectId;
	...
	useEffect(() => {
		...
		const handleNativeMouseUp = canvasEvents.handleNativeMouseUp(canvas);
		...
		return () => {
			...
			canvas.off('object:scaling', canvasEvents.manipulation.handleScalingStart);
